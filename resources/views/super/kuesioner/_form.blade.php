...
<div class="form-group">
	...
	<input type="text" name="pertanyaan[{{$i-1}}][pertanyaan][0]" class="form-control" value="{{$u->templatekues['pertanyaan']}}" />
	<input type="text" name="pertanyaan[{{$i-1}}][pertanyaan][1]" class="form-control" value="" placeholder="(optional)" />
