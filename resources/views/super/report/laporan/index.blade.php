...
<h3>{{$upp->nama}}</h3>
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="persyaratan"><span class="info-box-icon"><img class="fa" src="{{url('img/icon/persyaratan.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="prosedur"><span class="info-box-icon"><img class="ion" src="{{url('img/icon/prosedur.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="waktu"><span class="info-box-icon"><img class="ion" src="{{url('img/icon/waktu.svg')}}" height="60%"></img></span></a>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="produk"><span class="info-box-icon"><img src="{{url('img/icon/produk.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="kompetensi"><span class="info-box-icon"><img src="{{url('img/icon/kompetensi.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="sikap"><span class="info-box-icon"><img src="{{url('img/icon/perilaku.svg')}}" height="60%"></img></span></a>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="maklumat"><span class="info-box-icon"><img src="{{url('img/icon/maklumat.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="penanganan"><span class="info-box-icon"><img src="{{url('img/icon/penanganan.svg')}}" height="60%"></img></span></a>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="#" id="sarana"><span class="info-box-icon"><img src="{{url('img/icon/biaya.svg')}}" height="60%"></img></span></a>
