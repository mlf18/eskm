  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="{{route('upp.upp.profil')}}"><i class="fa fa-user"></i> <span>Profil</span></a></li>
        <li><a href="{{route('upp.kuesionerv2.index')}}"><!-- <i class="fa fa-calendar"></i>  --><span>Kuesioner</span></a></li>
        <li><a href="#"><!-- <i class="fa fa-calendar"></i>  --><span>Responden</span></a></li>
        <li><a href="{{route('upp.report.kuesioner.index')}}"><!-- <i class="fa fa-calendar"></i>  --><span>Laporan</span></a></li>
